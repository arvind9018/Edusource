...
// NEW TUTORIAL PAGE IMPORTS
import TutorialsPage from './pages/TutorialsPage'; // Import the list page
import TutorialDetailPage from './pages/TutorialDetailPage'; // Import the detail page
