...
import { Dashboard as DashboardIcon, School as CoursesIcon, Article as BlogsIcon, VideoLibrary as TutorialsIcon } from '@mui/icons-material'; // Import the new TutorialsIcon
import { useNavigate } from 'react-router-dom';

import InstructorProfile from './InstructorProfile';
import InstructorCourses from './InstructorCourses';
import InstructorBlogs from './InstructorBlogs';
import InstructorTutorials from './InstructorTutorials'; // Import the new component
                ...
                <Grid item xs={12}>
                    <Paper elevation={4} sx={{ p: 2, height: '100%', backgroundColor: 'white', borderRadius: 2 }}>
                        ...
                        <InstructorCourses
                            ...
                            onError={displayError}
                            onSuccess={displaySuccess}
                            onCoursesUpdated={handleCoursesAndSpecializationsUpdated}
                            fetchSpecializationsData={fetchSpecializationsData}
                        />
                        ...
                        {/* Add the new Tutorials section here */}
                        <Box sx={{ mt: 4, pt: 2, borderTop: '1px solid', borderColor: 'divider' }}>
                            <Typography variant="h5" color="primary.main" gutterBottom sx={{ display: 'flex', alignItems: 'center' }}>
                                <TutorialsIcon sx={{ mr: 1 }} /> Tutorial Management
                            </Typography>
                            <InstructorTutorials
                                user={user}
                                instructorData={instructorData}
