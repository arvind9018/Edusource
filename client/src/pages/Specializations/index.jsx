...
const SpecializationsPage = () => {
  ...
  // Calculate the specializations to display on the current page
  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  const currentSpecializations = specializations.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
      ...
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          <Typography variant="h6" color="text.secondary">
            Expand your skills with our complete catalog of expert-designed
            specializations.
          </Typography>
        </Box>
